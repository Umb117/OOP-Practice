...
public class TestSubject : ISubject
{
    ...
    private TestSubject(string name, int examScores, int authorId, IList<ILaboratory> labs, IList<ILecture> lectures, int? originalId = null)
    {
        Id = _generalId;
        Name = name;
        Scores = examScores;
    ...
    public class TestSubjectBuilder : ISubjectBuilder
    {
        ...
        public Result Build()
        {
            ...
            return new Result.SuccessWithEntity<TestSubject>(new TestSubject(
    ...
    public ISubject Clone()
    {
        ...
        return new TestSubject(Name, Scores, CurrentUser.CurrUser.Id, Labs, Lectures, Id);
    }
    ...
    public Result Edit(string? newName, int? newScores)
    {
        ...
        if (newScores != null) Scores = (int)newScores;
